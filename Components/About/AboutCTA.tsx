        ...
        <div className="relative overflow-hidden rounded-3xl border border-[#c8a96e]/20 bg-white/[0.02] p-8 sm:p-12 lg:p-16 text-center">
          ...
          <div className="relative">
            ...
            <p className="text-white/60 text-base sm:text-[17px] max-w-2xl mx-auto mb-10 leading-relaxed">
              Whether you need fractional CFO support, a governance review, a
              treasury strategy, or end-to-end financial transformation — I am
              available for corporations, SMEs, family-owned businesses,
              development organizations, and Boards of Directors.
            </p>
