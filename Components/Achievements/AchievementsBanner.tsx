...
export default function AchievementsBanner() {
  return (
    <section
      ...
      aria-label="Achievements page banner"
    >
      {/* Radial glow */}
      <div
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-10 w-full z-10">
        ...
        <p className="text-white/60 text-base sm:text-[17px] leading-relaxed max-w-[620px] mb-10">
          A record of strategic leadership, governance reform, financial transformation,
          and professional excellence — built through decades of hands-on engagement
          with corporations, development organizations, and Boards of Directors.
        </p>
