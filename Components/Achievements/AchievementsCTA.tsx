      ...
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-10 z-10">
        <div className="relative overflow-hidden rounded-3xl border border-[#c8a96e]/20 bg-white/[0.02] p-8 sm:p-12 lg:p-16 text-center">
          ...
          <div className="relative">
            ...
            <p className="text-white/60 text-base sm:text-[17px] max-w-2xl mx-auto mb-10 leading-relaxed">
              22+ years of demonstrated impact, four professional qualifications, and a
              multidisciplinary advisory approach — available for your organization,
              board, or specific financial challenge.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-10">
              ...
              <Link
                href="/profile"
                className="inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-full text-sm font-semibold tracking-wider uppercase border border-white/15 text-white/80 hover:border-[#c8a96e]/50 hover:text-white hover:bg-white/5 transition-all duration-300 min-w-[220px]"
              >
                View Full Profile
              </Link>
            </div>
