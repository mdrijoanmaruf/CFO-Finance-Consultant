...
export default function ProfileBanner() {
  return (
    <section
      ...
      aria-label="Profile page banner"
    >
      {/* Radial glow */}
      <div
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-10 w-full z-10">
        ...
        <p className="text-white/40 text-sm sm:text-base tracking-[0.15em] uppercase font-medium mb-6">
          CFO&nbsp;|&nbsp;Corporate Finance &amp; Governance Consultant
        </p>

        <p className="text-white/60 text-base sm:text-[17px] leading-relaxed max-w-[580px] mb-10">
          22+ years of hands-on financial leadership, governance advisory, and
          corporate finance experience across diverse industries and sectors.
        </p>
