...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-10 w-full py-20 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-20 items-center">
          ...
          <div className="flex flex-col gap-7">
            ...
            <div className="inline-flex items-center gap-2.5 w-fit">
              ...
              <span className="text-[#c8a96e] text-xs tracking-[0.25em] uppercase font-semibold">
