        ...
        <div className="flex flex-col xl:flex-row gap-4 items-stretch xl:items-center">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-11 pr-10 py-3 text-sm bg-black/20 border border-white/10 text-white placeholder-white/30 rounded-xl focus:outline-none focus:border-[#c8a96e]/50 focus:bg-black/40 transition-all"
            />
            {searchQuery && (
              <button
                type="button"
            ...
            {[
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-semibold tracking-wider transition-all duration-300 whitespace-nowrap ${
                  roleFilter === value
                    ? "bg-gradient-to-r from-[#c8a96e] to-[#a07840] text-white shadow-md shadow-[#c8a96e]/20"
          ...
          <div className="flex items-center gap-3 shrink-0 flex-wrap">
            ...
            <div className="flex items-center gap-2 px-4 py-2.5 bg-[#c8a96e]/10 border border-[#c8a96e]/20 rounded-xl">
              <FiShield className="w-4 h-4 text-[#c8a96e]" />
                    ...
                    return (
                      <tr
                        ...
                        className={`transition-colors duration-200 group ${
                          isSuper
                            ? "bg-[#c8a96e]/5 hover:bg-[#c8a96e]/10"
                            : user.role === "admin"
                            ? "hover:bg-white/5"
                            : "hover:bg-white/[0.02]"
                        }`}
                      >
                          ...
                          <div className="flex items-center gap-4">
                            {user.image ? (
                              <img
                                ...
                                className={`w-10 h-10 rounded-full object-cover shrink-0 ${
                                  isSuper ? "ring-2 ring-[#c8a96e] ring-offset-2 ring-offset-[#060e1c]" : "border border-white/10"
                                }`}
                              />
                            ) : (
                              <div
                                className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-sm shrink-0 shadow-md ${
                                  isSuper
                                    ? "bg-gradient-to-tr from-[#c8a96e] to-[#a07840] ring-2 ring-[#c8a96e] ring-offset-2 ring-offset-[#060e1c]"
                                    : user.role === "admin"
                            ...
                            <div>
                              <p className="font-semibold text-sm text-white tracking-wide flex items-center gap-2">
                                {user.name}
                                {isSuper && (
                                  <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[9px] font-bold tracking-widest uppercase bg-[#c8a96e]/20 text-[#c8a96e] border border-[#c8a96e]/30">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          {isSuper ? (
                            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold tracking-wide bg-[#c8a96e]/20 text-[#c8a96e] border border-[#c8a96e]/30 shadow-inner">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right">
                          <div className="flex items-center justify-end gap-2">
                            {isSuper ? (
                              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-bold tracking-widest uppercase text-[#c8a96e] bg-[#c8a96e]/10 border border-[#c8a96e]/20 rounded-lg cursor-not-allowed">
                              ...
                              <button
                                type="button"
                                onClick={() => toggleUserRole(user._id, user.role)}
                                className="px-3 py-1.5 text-[11px] font-bold tracking-widest uppercase text-black bg-gradient-to-r from-[#c8a96e] to-[#a07840] shadow-md shadow-[#c8a96e]/20 hover:shadow-[#c8a96e]/40 rounded-lg transition-all active:scale-95"
                              >
                                Make Admin
                              </button>
                            )}
