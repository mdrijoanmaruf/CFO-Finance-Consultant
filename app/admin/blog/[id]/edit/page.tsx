...
export default function EditBlogPostPage({
  ...
  const handleContentChange = (html: string) => {
    if (activeLang === "en") {
      set("content", html);
      set("readTime", estimateReadTime(html));
    } else {
      set("contentBn", html);
    }
  };
  ...
  const handleSave = async (publishNow?: boolean) => {
    ...
    try {
      ...
      if (data.success) {
        toast.success(
          publishNow ? "Post published!" : "Changes saved",
          { style: { background: "#333", color: "#fff" } }
        );
        router.push("/admin/blog");
      } else {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        >
          <FiArrowLeft className="w-4 h-4" /> Back to Posts
        </Link>
      </div>
              ...
              <div className="bg-black/20 rounded-xl p-5 shadow-sm border border-white/5">
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <textarea
                      value={
                        activeLang === "en" ? form.excerpt : form.excerptBn
                      }
                      onChange={(e) =>
                        set(
                          activeLang === "en" ? "excerpt" : "excerptBn",
                          e.target.value
                        )
                      }
                      placeholder={
                        activeLang === "en"
                          ? "Brief summary shown in post cards..."
                          : "সংক্ষিপ্ত বিবরণ..."
                      }
                      rows={3}
                      maxLength={300}
                  ...
                  <div>
                    ...
                    <RichTextEditor
                      key={activeLang}
                      content={
                        activeLang === "en" ? form.content : form.contentBn
                      }
            ...
            <div className="space-y-6">
              ...
              <div className="bg-black/20 rounded-xl p-5 shadow-sm border border-white/5">
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 text-sm bg-white/5 border border-white/10 rounded-xl text-white focus:ring-2 focus:ring-[#c8a96e] focus:border-transparent outline-none cursor-pointer appearance-none"
                >
              ...
              <div className="bg-black/20 rounded-xl p-5 shadow-sm border border-white/5">
                ...
                <p className="text-[11px] text-white/40 mt-2 leading-relaxed">
                  Current view count. Increments automatically on each visit.
                </p>
              </div>
              ...
              <div className="bg-black/20 rounded-xl p-5 shadow-sm border border-white/5">
                ...
                />
                <p className="text-[11px] text-white/40 mt-2 leading-relaxed">
                  Used for custom sorting (lower numbers appear first).
                </p>
              </div>
            </div>
          </div>
